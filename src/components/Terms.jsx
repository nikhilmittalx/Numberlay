...
const Terms = () => {
  return (
    <>
        <div className='flex flex-col mt-[5rem] px-[2rem]'>
            <div className='text-[1.5rem] md:text-[2rem] slg:text-[2.5rem] font-[600] text-center'>Privacy Policy and Terms of Use</div>
            ...
            <div className='font-[600] mt-[2rem]'>Information We Collect:</div>
            ...
            <div className='font-[600] mt-[2rem]'>Automatically Collected Information: </div>
            ...
            <div className='font-[600] mt-[2rem]'>Use of Collected Information:</div>
            {/* <div> */}
            ...
            <div className='font-[600] mt-[2rem]'>Data Security: </div>
            ...
            <div className='font-[600] mt-[2rem]'>Google Analytics: </div>
            ...
            <div className='font-[600] mt-[2rem]'>Cookies and Tracking Technologies: </div>
            ...
            <div className='font-[600] mt-[2rem]'>Your Choices: </div>
            ...
            <div className='font-[600] mt-[2rem]'>Changes to the Privacy Policy: </div>
            ...
            <div className='font-[600] mt-[2rem]'>Contact Us: </div>
