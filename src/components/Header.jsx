    ...
    <>
        <div className='flex justify-center smmx:mx-[1vw] mx-[3vw] mt-[7rem]'>
            <div className='flex flex-col smmx:px-[0.8rem] px-[1rem] font-[400]'>
                ...
                <div className='mt-[1.5rem] text-[1.25rem]'>Numberlay, your partner in efficient bookkeeping and accounting solutions. We specialize in supporting small and individual businesses with our detail-oriented approach and personalised solutions tailored to meet the unique needs of your enterprise.</div>
